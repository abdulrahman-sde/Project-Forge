...
export default function Footer() {
  ...
  return (
    <footer className="bg-(--color-ink) text-[rgba(255,255,255,0.7)] pt-16 pb-8">
      <div className="section-wrapper">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2.5 text-sm hover:text-amber transition-colors"
              >
                <Mail size={14} />
              ...
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="text-sm hover:text-amber transition-colors duration-300"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a
              href="#"
              className="text-xs text-[rgba(255,255,255,0.4)] hover:text-amber transition-colors"
            >
              Privacy Policy
            </a>
            <a
            ...
            <button
              onClick={scrollToTop}
              className="w-10 h-10 rounded-full border border-[rgba(255,255,255,0.15)] flex items-center justify-center hover:bg-amber hover:border-amber hover:text-(--color-ink) transition-all duration-300"
